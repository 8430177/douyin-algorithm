...
PROTOBUF_CONSTEXPR Argus::Argus(
  ...
  , /*decltype(_impl_.pskcalhash_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.pskversion_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.actionrecord_)*/nullptr
...
PROTOBUF_CONSTEXPR ActionRecord::ActionRecord(
    ::_pbi::ConstantInitialized): _impl_{
...
struct ActionRecordDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ActionRecordDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ActionRecordDefaultTypeInternal() {}
  union {
    ActionRecord _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ActionRecordDefaultTypeInternal _ActionRecord_default_instance_;
...
const uint32_t TableStruct_argus_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Argus, _impl_.actionrecord_),
...
class Argus::_Internal {
 public:
  ...
  static const ::ActionRecord& actionrecord(const Argus* msg);
...
const ::ActionRecord&
Argus::_Internal::actionrecord(const Argus* msg) {
  return *msg->_impl_.actionrecord_;
}
...
Argus::Argus(const Argus& from)
  ...
  _impl_.pskcalhash_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.pskcalhash_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_pskcalhash()) {
    _this->_impl_.pskcalhash_.Set(from._internal_pskcalhash(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_actionrecord()) {
    _this->_impl_.actionrecord_ = new ::ActionRecord(*from._impl_.actionrecord_);
  }
...
inline void Argus::SharedDtor() {
  ...
  _impl_.pskcalhash_.Destroy();
  _impl_.pskversion_.Destroy();
  if (this != internal_default_instance()) delete _impl_.actionrecord_;
}
...
// @@protoc_insertion_point(message_clear_start:Argus)
  ...
  if (cached_has_bits & 0x0000007cu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _impl_.pskcalhash_.ClearNonDefaultToEmpty();
    }
  }
  ...
  ::memset(&_impl_.magic_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&_impl_.magic_)) + sizeof(_impl_.createtime_));
    ...
    switch (tag >> 3) {
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 122)) {
          ptr = ctx->ParseMessage(_internal_mutable_actionrecord(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 19:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 154)) {
          auto str = _internal_mutable_pskcalhash();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* Argus::_InternalSerialize(
  ...
  if (this->_internal_platform() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(11, this->_internal_platform(), target);
  }
  ...
  // .ActionRecord actionRecord = 15;
  if (this->_internal_has_actionrecord()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(15, _Internal::actionrecord(this),
        _Internal::actionrecord(this).GetCachedSize(), target, stream);
  }
  ...
  if (_internal_has_pskcalhash()) {
    target = stream->WriteBytesMaybeAliased(
        19, this->_internal_pskcalhash(), target);
  }
...
void Argus::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000007cu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _this->_internal_set_pskcalhash(from._internal_pskcalhash());
    }
  }
  if (!from._internal_pskversion().empty()) {
  ...
  if (from._internal_has_actionrecord()) {
    _this->_internal_mutable_actionrecord()->::ActionRecord::MergeFrom(
        from._internal_actionrecord());
  }
  ...
  if (cached_has_bits & 0x00000080u) {
    _this->_internal_set_isapplicense(from._internal_isapplicense());
  }
...
void Argus::InternalSwap(Argus* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.pskcalhash_, lhs_arena,
      &other->_impl_.pskcalhash_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(Argus, _impl_.actionrecord_)>(
          reinterpret_cast<char*>(&_impl_.actionrecord_),
          reinterpret_cast<char*>(&other->_impl_.actionrecord_));
}
...
class ActionRecord::_Internal {
 public:
};

ActionRecord::ActionRecord(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:ActionRecord)
}
ActionRecord::ActionRecord(const ActionRecord& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ActionRecord* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:ActionRecord)
}

inline void ActionRecord::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
ActionRecord::~ActionRecord() {
  // @@protoc_insertion_point(destructor:ActionRecord)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ActionRecord::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}
...
// @@protoc_insertion_point(message_clear_start:ActionRecord)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ActionRecord::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* ActionRecord::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:ActionRecord)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ActionRecord)
  return target;
}

size_t ActionRecord::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ActionRecord)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ActionRecord::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ActionRecord::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ActionRecord::GetClassData() const { return &_class_data_; }


void ActionRecord::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ActionRecord*>(&to_msg);
  auto& from = static_cast<const ActionRecord&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:ActionRecord)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:ActionRecord)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ActionRecord::InternalSwap(ActionRecord* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ActionRecord, _impl_.settingcount_)
      + sizeof(ActionRecord::_impl_.settingcount_)
      - PROTOBUF_FIELD_OFFSET(ActionRecord, _impl_.signcount_)>(
          reinterpret_cast<char*>(&_impl_.signcount_),
          reinterpret_cast<char*>(&other->_impl_.signcount_));
}

::PROTOBUF_NAMESPACE_ID::Metadata ActionRecord::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_argus_2eproto_getter, &descriptor_table_argus_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::ActionRecord*
Arena::CreateMaybeMessage< ::ActionRecord >(Arena* arena) {
  return Arena::CreateMessageInternal< ::ActionRecord >(arena);
}
